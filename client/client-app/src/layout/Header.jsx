        ...
        <div className='header'>
            <div className="header-inner">
                ...
                <div className="search-box">
                    {/* 프로필 사진이 있을 때 */}
                    {jwtSets.parsedToken.payload != null && jwtSets.parsedToken.payload.users.profileNo != 0 && (
                        <a href="/myPage/myInfo">
                            <img src={`api/file/img/${jwtSets.parsedToken.payload.users.profileNo??0}`} alt="프로필사진" id="profile" style={{ width: '50px', height: '50px', borderRadius: '50%', boxShadow: '0px 0px 8px gray' }} />
                        </a>
                    )}
                    {/* 프로필 사진이 없을 때 */}
                    {jwtSets.parsedToken.payload != null && jwtSets.parsedToken.payload.users.profileNo == 0 && (
