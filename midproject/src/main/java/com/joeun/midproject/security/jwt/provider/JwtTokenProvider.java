package com.joeun.midproject.security.jwt.provider;
...
import com.joeun.midproject.prop.JwtProps;
import com.joeun.midproject.security.jwt.constants.SecurityConstants;
...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<String> roles) throws Exception {
        ...
        Integer profileNo = userInfo.getProfileNo();
        ...
        String jwt = Jwts.builder()
                ...
                .claim("profileNo", "" + profileNo)                              // 클레임 설정: 사용자 닉네임
        ...
        try {
            ...
            try {
                ...
                if( userInfo != null ) {
                    ...
                    user.setProfileNo(userInfo.getProfileNo());
